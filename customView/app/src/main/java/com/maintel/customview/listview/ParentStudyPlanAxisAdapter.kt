 ...
 * @date 2018/10/22
 */
class ParentStudyPlanAxisAdapter(var dataList: List<ParentStudyPlanAxisBean>, val context: Context) : RecyclerView.Adapter<ParentStudyPlanAxisAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ParentStudyPlanAxisAdapter.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_study_plan_axis, parent, false)
        return ParentStudyPlanAxisAdapter.ViewHolder(view)
    }
