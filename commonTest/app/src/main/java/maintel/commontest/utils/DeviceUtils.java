...
//        WindowManager wm = (WindowManager) MyApplication.getInterface()
//                .getSystemService(Context.WINDOW_SERVICE);
//        int width = wm.getDefaultDisplay().getWidth();
//        return width;
//    }
...
//    }
    ...
    public static int dp2px(float dpVal) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                dpVal, MyApplication.getInterface().getResources().getDisplayMetrics());
    }
    ...
    public static int sp2px(float spVal) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
                spVal, MyApplication.getInterface().getResources().getDisplayMetrics());
    }
    ...
    public static float px2dp(float pxVal) {
        final float scale = MyApplication.getInterface().getResources().getDisplayMetrics().density;
        return (pxVal / scale);
    }
    ...
    public static float px2sp(float pxVal) {
        return (pxVal / MyApplication.getInterface().getResources().getDisplayMetrics().scaledDensity);
    }
...
//            CommonUtils.showLog("有权限");
            return true;
        } else {
            //
//            CommonUtils.showLog("没有权限");
            return false;
        }
    }
