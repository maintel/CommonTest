...
package com.a17zuoye.zxing.camera;
...
import com.a17zuoye.zxing.camera.open.OpenCamera;
import com.a17zuoye.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    private OpenCameraInterface threadOpen;
    ...
    public synchronized void openDriver(SurfaceHolder holder) throws IOException {
        ...
        if (theCamera == null) {
            theCamera = threadOpen.getOpenCamera();
            if (theCamera == null) {
    ...
    /**
     * Convenience method for {@link com.a17zuoye.zxing.CaptureActivity}
     *
